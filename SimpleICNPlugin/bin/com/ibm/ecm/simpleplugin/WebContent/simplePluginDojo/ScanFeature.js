define([
	...
	"dojo/text!./templates/ScanFeature.html"
],
function(declare,
		_LaunchBarPane,
		template) {
	/**
	 * @name simplePluginDojo.ScanFeature
	 * @class 
	 * @augments ecm.widget.layout._LaunchBarPane
	 */
	return declare("simplePluginDojo.ScanFeature", [
		_LaunchBarPane
	], {
		/** @lends simplePluginDojo.ScanFeature.prototype */
