 ...
 * web browser.
 */
public class WorklistCountResponse extends PluginResponseFilter {
	...
	public void filter(String serverType, PluginServiceCallbacks callbacks,
		...
		try{
			...
			//dsICM.connect("LSConnection","icmadmin","BigBlue!@#",""); 
			dsICM.connect("LSConnection","icmadmin","BigBlue123",""); 
            /*conn.setDsType("ICM");
