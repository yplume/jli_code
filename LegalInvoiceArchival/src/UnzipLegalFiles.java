...
public class UnzipLegalFiles {
	...
	public void UnzipFiles1() {
		...
		////String unzipFileDir = "\\\\usncdvkfxcrtr2v\\ExportToKofax\\LZipOutput\\";
    	...
    	try{
    		...
    		if (AL != null && AL.size() != 0) {
    			...
    			//for(int i = 0; i < fList.length; i++){
	        		...
	        		invNumber = fileName1.substring(invIndex+3);
			    		...
			    		for(int k = 0; k < fList.length; k++){
						    ...
						    //if(isPDF && fileName2.endsWith(fileName1 + ".pdf")){
				    			...
				    			//if(fileName2.equalsIgnoreCase(fileName1)){
				    	    		...
				    	    		createNewXML(metaDate, newKofaxXMLDir + fileName2 + ".xml", newKofaxXMLDir, attachAL, invNumber);
    ...
    public static void main (String[] arg){
    	UnzipLegalFiles uz = new UnzipLegalFiles();
