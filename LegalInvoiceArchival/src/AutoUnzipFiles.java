...
public class AutoUnzipFiles {
	...
	//private static String zipFileDir = "c:/WD/InvoiceArchiveTest/tempZip/";
	private static String zipErrDir = "c:/WD/InvoiceArchiveTest/Ziperror/";
	private static String zipFileDir = "c:/WD/InvoiceArchiveTest/ZipInput/";
	/*public AutoUnzipFiles(){
	...
	//public void UnzipFiles1() {
		...
		String unzipFileDir = "c:/WD/InvoiceArchiveTest/ZipOutput/";
		
        
        File zipErrFile = new File("c:/WD/InvoiceArchiveTest/Ziperror");
        
        //String movezipFileDir = "\\\\usncdvkfxcrtr2v\\ExportToKofax\\movezipoutput\\";
        
        String newDestDir = "c:/WD/InvoiceArchiveTest/OnlineImages";
        ...
        String newDestKofaxDir = "c:/WD/InvoiceArchiveTest/";
        ...
        //}
			...
			//new File("c://WD/InvoiceArchiveTest//" + extractFileName + ".zip").renameTo(new File(zipErrDir + extractFileName + ".zip"));
        	try{
    ...
    //public static void createNewXML(XMLReader xmlreader, String unzipedXml, String newKofaxXml, String cXML, ArrayList <File> pdfFileNameAL){
    	...
    	if(!xmlreader.getInvoiceSubmissionMethod().equalsIgnoreCase("PaperViaICS")){
	    	...
	    	System.out.println("systemID in Unzip : " + systemID);
