...
public class Copy_4_of_ExportItems {
	    ...
	    try{
			...
			for (int i=0; i<itemTypes.size(); i++) {
            	...
            	if (initRun.equalsIgnoreCase("1")){
            		...
            		if(itemTypes.get(i).equals("APU")){
            			sql =  "select CREATETS, ATTR0000001034, ATTR0000001032, ATTR0000001080 from " + tableName + " where ((ATTR0000001080>'" + xDaysAgo +"' and ATTR0000001080<'" + nowDate +"') or (ATTR0000001032>'" + xDaysAgo +"' and ATTR0000001032<'" + nowDate + "')) and ATTR0000001079 is null";
            	...
            	//queryString = "/" + (String)itemTypes.get(i) + "[@VERSIONID = latest-version(.) AND (@CREATETS>\"" + xDaysAgo + "\") AND (@CREATETS<=\"2014-05-22 13:57:56.509\")]";	
            			...
            			sql =  "select CREATETS, ATTR0000001034, ATTR0000001032 from " + tableName + " where (ATTR0000001032>'" + xDaysAgo +"' and ATTR0000001032<'" + nowDate + "')";
