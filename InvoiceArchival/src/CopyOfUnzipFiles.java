...
public class CopyOfUnzipFiles {
	...
	public void UnzipFiles1() {
        ...
        File zipErrprFile = new File("\\\\usncdvkfxcrtr2v\\ExportToKofax\\Ziperror\\");
        ...
        System.out.println("zipErrprFile isDirectory() = "+zipErrprFile.isDirectory());
        System.out.println("zipErrprFile length = "+zipErrprFile.list().length);
	       
        if(zipErrprFile.isDirectory() && zipErrprFile.list().length == 0) {
    ...
    /*public static void main(String[] args) {
    	...
    	class checkZip extends TimerTask {
    		 
    		public void run() {
    	 
    			//String zipFileDir = "c:/WD/zipinput/";
		        
		        //String unzipFileDir = "c:/WD/zipoutput/";
         ...
         timer.schedule(new checkZip(), 10, 60*1000); 
    ...
    */
    ...
    /*private static void coypZipFile(File org, File move){
    	System.out.println("move zips="+move);
    	org.renameTo(move);
    ...
    public static void findxmlfiles(String unzipFileDir, String newXMLDir, String newKofaxXMLDir){
    	...
    	for(int i=0; i<fList.length; i++){
				    			...
				    			*/
			    	    		...
			    	    		for(int j=k+1; j<fList.length; j++){
				    	            ...
				    	            if(attachmentfileName.indexOf(fileName2 + "_attachments")!=-1){
				    	    			...
				    	    			//attachPDFFileName.renameTo(new File("\\\\usncdvkfxcrtr2v\\ExportToKofax\\" + xmlpdfFileName +".pdf"));
				    	    			//fList[i].renameTo(new File("\\\\usncdvkfxcrtr2v\\ExportToKofax\\" + attachmentfileName));
			...
			File file = new File("\\usncdvkfxcrtr2v\\ExportToKofax\\Ziperror\\unzipfileserror1.txt");
        	try{
				BufferedWriter output = new BufferedWriter(new FileWriter(file));
				output.write(e.getMessage());
				output.close();
        	}catch(Exception exception){
        		System.out.println("unzipfileserror1: " + exception);
        	}
		}
    ...
    //public static void createNewXML(XMLReader xmlreader, String unzipedXml, String newKofaxXml, String cXML, ArrayList <File> pdfFileNameAL){
    	...
    	if(!xmlreader.getInvoiceSubmissionMethod().equalsIgnoreCase("PaperViaICS")){
	    	try{
				...
				System.out.println(e.getMessage());
				File file2 = new File("\\usncdvkfxcrtr2v\\ExportToKofax\\Ziperror\\unzipfileserror4.txt");
	        	try{
    ...
    private static void unzip(String zipFilePath, String destDir, String newDir) {
        ...
        try {
            ...
            e.printStackTrace();
            File file = new File("\\usncdvkfxcrtr2v\\ExportToKofax\\Ziperror\\unzipfileserror3.txt");
        	try{
				BufferedWriter output = new BufferedWriter(new FileWriter(file));
				output.write(e.getMessage());
				output.close();
