...
public class UploadServletAddEUDev extends javax.servlet.http.HttpServlet implements Servlet
{
  ...
  protected String attConvert(String attribute, String itemtype){
	...
	//attr0000001031 prod & dev attr0000001072
	  ...
	  if(attribute.equalsIgnoreCase("attr0000001031") && (itemtype.equalsIgnoreCase("Ariba_Online_Invoice_Archive") || itemtype.equalsIgnoreCase("EU_Ariba_Online_Archive")))
		  attCov = "Vendor_Num";
	  if(attribute.equalsIgnoreCase("attr0000001031") && (!itemtype.equalsIgnoreCase("Ariba_Online_Invoice_Archive") && !itemtype.equalsIgnoreCase("EU_Ariba_Online_Archive")))
