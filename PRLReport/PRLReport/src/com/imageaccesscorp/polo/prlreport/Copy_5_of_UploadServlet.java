...
public class Copy_5_of_UploadServlet extends javax.servlet.http.HttpServlet implements Servlet
{
  ...
  public Copy_5_of_UploadServlet() {}
	        ...
	        System.out.println("[UploadServlet]getImgage ......");
	          ...
	          while (iter.more())
	          {
	            ...
	            while (attIter.more()) {
	              ...
	              try {
	            	  ...
	            	  dataValue =  "";
		                ...
		                if ((itemType.equals("SAP_Ariba_Invoices") || itemType.equals("EU_Ariba_Invoices") || itemType.equals("Ariba_Online_Invoice_Archive")) && aDef.getName().equals("AssignmentNumber")){
		                	if(ddo.getDataByName(aDef.getName()) != null ){ 
	            ...
	            System.out.println("[UploadServlet]hm="+hm);
	            	metaData += hm.get("Vendor_Number") + "," + hm.get("Vendor_Name") + "," + hm.get("Invoice_Num") + "," + hm.get("Tax_Amount") + "," + hm.get("Invoice_Amount") + "," + hm.get("Invoice_Date") +  "," + hm.get("PO_Number") +  "," + hm.get("TransactionNumber")  + "," ;
