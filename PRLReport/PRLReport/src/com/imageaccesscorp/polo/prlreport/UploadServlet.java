...
public class UploadServlet extends javax.servlet.http.HttpServlet implements Servlet
{
  ...
  */
  ...
  protected String attConvert(String attribute, String itemtype){
	...
	//  if(attribute.equalsIgnoreCase("attr0000001163"))
	  ...
	  System.out.println(" [UploadServlet] attCov =" + attCov);
	      ...
	      if (results.cardinality() == 0) {
	        ...
	        System.out.println("[UploadServlet]getImgage ......");
	          ...
	          while (iter.more())
	          {
	            ...
	            Vendor_Number = (String)hm.get("Vendor_Number");
	            if(Vendor_Number == null)
	            	Vendor_Number = "";
	            
	            Vendor_Num = (String)hm.get("Vendor_Num");
	            if(Vendor_Num == null)
	            	Vendor_Num = "";
	            
	            System.out.println("[UploadServlet]hm="+hm);
	            	metaData += Vendor_Number + Vendor_Num + "," + hm.get("Vendor_Name") + "," + hm.get("Invoice_Num") + "," + hm.get("Tax_Amount") + "," + hm.get("Invoice_Amount") + "," + hm.get("Invoice_Date") +  "," + hm.get("PO_Number") +  "," + hm.get("TransactionNumber")  + "," ;
