...
public class C extends HttpServlet implements com.ibm.mm.sdk.common.DKConstantICM
{
...
*/
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
			...
			connection.connect();
			String query = null;
			System.out.println("Tx_Number = "+httpservletrequest.getParameter("Tx_Number") +"     " + httpservletrequest.getParameter("Entity"));
			
			// | /ClubMonaco8525 | /ClubMonaco8550 | /Corporate8600 | /Home8300 | /Legal_Invoices | /RLMedia8700 | /Retail8500 | /Wholesale8100
			if (httpservletrequest.getParameter("Entity").equalsIgnoreCase("Gen_Invoices") || httpservletrequest.getParameter("Entity").equalsIgnoreCase("SAP_Invoices"))
				query = "( (/" + httpservletrequest.getParameter("Entity") + ") [@Tx_Number = \"" + httpservletrequest.getParameter("Tx_Number") + "\" and @Vendor_Number = \"" + httpservletrequest.getParameter("Vendor_Number") + "\"] )";
			if (httpservletrequest.getParameter("Entity").equalsIgnoreCase("SAP_Ariba_Invoices") || httpservletrequest.getParameter("Entity").equalsIgnoreCase("EU_Ariba_Invoices"))
				query = "( (/" + httpservletrequest.getParameter("Entity") + ") [@AssignmentNumber = \"" + httpservletrequest.getParameter("Tx_Number") + "\" and @Vendor_Number = \"" + httpservletrequest.getParameter("Vendor_Number") + "\"] )";
			...
			if ((ddo = cursor.fetchNext()) != null)	
			{
				/*try
		          ...
		          dsICM.destroy();
					...
					httpservletresponse.sendRedirect("http://usncdvcmweb2v:500/PoloInvoiceViewer/NotFound.jsp?action=viewinvoice&transactionnumber=" + httpservletrequest.getParameter("Tx_Number"));
