    ...
    public void UpdateWorkflow(){
	    ...
	    try{
	    	...
	    	try{
	    		...
	    		System.out.println("Get connection connectionUS.");
	    		connectionCA  = DriverManager.getConnection(url, "Kofax02", "IMG21DOC");
	    		System.out.println("Get connection connectionCA.");
            ...
            */
            ...
            if (workPackages.cardinality() == 0) {
                ...
                while (iter.more()) {
                    ...
                    else if(processName.equalsIgnoreCase("AP-CA Process"))
                		exceptionStepName = "Send Back To ErrorWorklistCA";
                    else
