...
public class CopyOfViewInvoice extends HttpServlet implements com.ibm.mm.sdk.common.DKConstantICM
{
...
*/
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
			...
			connection.connect();
			String query = null;
			System.out.println("Tx_Number = "+httpservletrequest.getParameter("Tx_Number") +"     " + httpservletrequest.getParameter("itemtype"));
